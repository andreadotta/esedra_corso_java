...
public class SQLiteDialect extends Dialect {
	...
	private static class SQLiteUniqueDelegate extends DefaultUniqueDelegate {
		...
		/**
		 * SQLite uses table creation sql to define unique constraints, and do not
		 * support alter table sql to add constraints. Such as "create table person(
		 * first_name varchar(255),last_name varchar(255),unique(first_name, last_name)
		 * )".
		 */
		@Override
