...
function createRowElements(item, row) {
	...
	updBtn.addEventListener("click", function () {
		...
		formImage = document.getElementById("image-form").elements;
		formImage["id"].value = this.getAttribute("data-id");
		formImage["src"].value = src.innerHTML;		
		formImage["name"].value = name.innerHTML;
	});
