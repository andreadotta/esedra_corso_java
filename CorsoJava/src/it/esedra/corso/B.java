...
public class B extends A {
	...
	public B() {
		...
		//in pratica i campi con lo stess onome tra una classe base e una derivata, sono 
		//sempre nascosti ma i metodi con la stessa segnatura, tra una classe base e una classe
