...
public class Snippet3009 {
	...
	public static void main(String[] args) {
		...
		// MyInterface2.foo(); non è possibile applicare l'ereditarietà ai metodi
		// statici
		// di interfaccia
		MyClass2.foo(); // ok
