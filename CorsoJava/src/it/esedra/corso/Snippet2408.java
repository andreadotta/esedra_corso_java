...
public class Snippet2408 {
	...
	public static void main(String[] args) {
		...
		/**
		 * dogs = wt; //tipi incompatibili
		 * Una lista di WhiteTerrier è diversa da una lista di Dog.
		 * 
		 *  dogs = wt;
		 ...
		 * covarianza
		 * <? extends bound_type>
		 * Nota: l'annotazione di varianza <?> è uno shortcut equivalente a <? extends Object>
		 * 
		 * controvarianza
		 * <? super bound_type>
		 * 
		 * 
		 * Nota: ? non può essre uisate nella sezione dei paramentri di tipo o anche come indicatore di tipo
		 * (x esempio per dichiarare una variabile locale a un metodo o a una classe)
		 */
		...
		//Siccome tutti i tipi generici sono invarianti il codice qui sotto non è ammesso
		...
		/*
		 * Restrizioni in:
		 * - utilizzo delle array
		 * - nei contesti static (vedi classe Numbers)
		 * - utilizzo delle variabili di tipo (vedi classi BiNumbers) 
		 * - utilizzo di cast e instanceof 
		 * - tipi primitivi: non è possibile utilizzare un tipo primitivo in una lista parametrizzata 
		 *   List<int> esem = 
		 * - nelle eccezioni (la vedremo in seguito quando affronteremo le eccezioni)
		 * - nell'overloading non è possibile che due o più metodi differiscano dal tipo parametrizzato del tipo generico:
