...
public class Snipppet1706 {
	...
	public static void main(String[] args) {
		...
		/**
		 * KEYWORD if / else do for beak switch continue return while throw assert
		 * synchronized try
		 */
		...
		// si evita l'errore di dangling else, cioè l'else che non è attribuito a nessun
		// if
	...
	public static void operators() {
		...
		/**
		 * Operatore logico condizionale AND (&&) logico condizionale OR (||) logico
		 * condizionale NOT (!) logico o negazione logica
		 * 
		 */
		...
		// il LINT è uno strumento che analizza il codice sorgente per contrassegnare
		// errori
		// di programmazione
		boolean r = !(q > 10);
